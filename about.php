        ...
        350px; overflow: hidden;">
            <div data-p="225.00">
                ...
                <div data-u="caption" data-t="0" style="position:absolute;top:0px;left:0px;width:1370px;height:220px;z-index:0;">
                    ...
                    <div style="position:absolute;top:140px;left:-20px;width:1080px;height:55px;z-index:0;font-size:40px;color:#ffffff;line-height:60px;color:white; font-family: serif;padding:5px;">INDIA'S FIRST INTERNATIONAL SEEDS COMPANY</div>
    ...
    <!-- #endregion Jssor Slider End -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 text-center wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                <br>
                <br>
                <h3 class="text-center"> Making Quality Seeds</h3> ​
                <h2 > <strong>ACCESSIBLE TO EVERYONE</strong> </h2>

                <br>
                <br>
                <br>
                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeInRight text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <img class="img-circle about-img" src="images/about/ceo.jpg" alt="CEO" style="height: 270px;width:250px;padding-top: 0px;">
                </div>

                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeInRight text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <img class="img-circle about-img" src="images/about/guy1.jpg" alt="CFO" style="height: 280px;width:250px;">
                </div>

                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeInRight text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <img class="img-circle about-img" src="images/about/guy2.jpg" alt="CTO" style="height: 270px;width:250px;padding-top: 0px;margin-top: 18px;">
                </div>
                <br>
                <br>
                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeIn text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <h4 class="text-center" style="color:black;font-size:22 px; ">S K MANJHI</h4>
                    <h5 style="font-size:20px" >Founder & CEO</h5>
                    <a href="https://in.linkedin.com/in/skmanjhiczs"> <img src="images/about/linkedinLogo.png" style="height: 40px; background: transparent;"></a>
                </div>

                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeIn text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <h4 style="color:black; ">Jane Doe</h4>
                    <h5>CFO</h5>
                    <a href="https://in.linkedin.com/in/skmanjhiczs"> <img src="images/about/linkedinLogo.png" style="height: 40px; background: transparent;"></a>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 wow fadeIn text-center" data-wow-duration="2s" data-wow-delay="0.6s" style="background: white">
                    <br>
                    <h4 style="color:black; ">John Doe</h4>
                    <h5>CTO</h5>
                    <a href="https://in.linkedin.com/in/skmanjhiczs"> <img src="images/about/linkedinLogo.png" style="height: 40px; background: transparent;"></a>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                            ...
                            <br>
                            <br>
                            <h3 style="color:#0D0D0D;"> Cropzonia Seeds</h3> ​
                            <h3 style="color:#0D0D0D;"> <strong>CORE VALUES</strong> </h3>
                        </div>

                        <div class="col-md-12 col-sm-12 col-xs-12    text-center wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                            <img src="images/about/coreValues.jpg" class="img-circle">
                        </div>
